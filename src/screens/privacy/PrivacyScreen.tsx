...
export default function PrivacyScreen() {
  ...
  return (
    ...
    >
      ...
      <h1 style={{ fontFamily: 'OpenSans_300Light', fontSize: 32 }}>Portals.net Privacy Policy</h1>
      <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>Last updated: September 29, 2020</p>
      <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
      ...
      <h1  style={{ fontFamily: 'OpenSans_300Light', fontSize: 32 }}>Interpretation and Definitions</h1>
      <h2  style={{ fontFamily: 'OpenSans_300Light', fontSize: 28 }}>Interpretation</h2>
      <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
      ...
      <h2  style={{ fontFamily: 'OpenSans_300Light', fontSize: 28 }}>Definitions</h2>
      <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>For the purposes of this Privacy Policy:</p>
      <ul style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
        <li>
          <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
        ...
        <li>
          <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
            ...
            this Agreement) refers to Mystify, Inc.
          </p>
          <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
      ...
      <h1  style={{ fontFamily: 'OpenSans_300Light', fontSize: 32 }}>Collecting and Using Your Personal Data</h1>
      <h2  style={{ fontFamily: 'OpenSans_300Light', fontSize: 28 }}>Types of Data Collected</h2>
      <h3  style={{ fontFamily: 'OpenSans_300Light', fontSize: 22 }}>Personal Data</h3>
      <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
      ...
      <ul style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
        <li>
          <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>Phone number</p>
        </li>
        <li>
          <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>Usage Data</p>
        </li>
      </ul>
      <h3  style={{ fontFamily: 'OpenSans_300Light', fontSize: 22 }}>Usage Data</h3>
      <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>Usage Data is collected automatically when using the Service.</p>
      <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
      ...
      <h3  style={{ fontFamily: 'OpenSans_300Light', fontSize: 22 }}>Information Collected while Using the Application</h3>
      <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
      ...
      <h2  style={{ fontFamily: 'OpenSans_300Light', fontSize: 28 }}>Use of Your Personal Data</h2>
      <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>The Company may use Personal Data for the following purposes:</p>
      <ul style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
        <li>
      ...
      <h2  style={{ fontFamily: 'OpenSans_300Light', fontSize: 28 }}>Retention of Your Personal Data</h2>
      <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
      ...
      <h2  style={{ fontFamily: 'OpenSans_300Light', fontSize: 28 }}>Transfer of Your Personal Data</h2>
      <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
      ...
      <h2  style={{ fontFamily: 'OpenSans_300Light', fontSize: 28 }}>Disclosure of Your Personal Data</h2>
      <h3  style={{ fontFamily: 'OpenSans_300Light', fontSize: 22 }}>Business Transactions</h3>
      <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
      ...
      <h3  style={{ fontFamily: 'OpenSans_300Light', fontSize: 22 }}>Law enforcement</h3>
      <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h3  style={{ fontFamily: 'OpenSans_300Light', fontSize: 22 }}>Other legal requirements</h3>
      <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
      ...
      <h2  style={{ fontFamily: 'OpenSans_300Light', fontSize: 28 }}>Security of Your Personal Data</h2>
      <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
      ...
      <h1  style={{ fontFamily: 'OpenSans_300Light', fontSize: 32 }}>GDPR Privacy</h1>
      <h2  style={{ fontFamily: 'OpenSans_300Light', fontSize: 28 }}>Legal Basis for Processing Personal Data under GDPR</h2>
      <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>We may process Personal Data under the following conditions:</p>
      <ul style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
        <li>
      ...
      <h2  style={{ fontFamily: 'OpenSans_300Light', fontSize: 28 }}>Your Rights under the GDPR</h2>
      <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
      ...
      <h2  style={{ fontFamily: 'OpenSans_300Light', fontSize: 28 }}>Exercising of Your GDPR Data Protection Rights</h2>
      <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
      ...
      <h1  style={{ fontFamily: 'OpenSans_300Light', fontSize: 32 }}>CCPA Privacy</h1>
      <h2  style={{ fontFamily: 'OpenSans_300Light', fontSize: 28 }}>Your Rights under the CCPA</h2>
      <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
      ...
      <h2  style={{ fontFamily: 'OpenSans_300Light', fontSize: 28 }}>Exercising Your CCPA Data Protection Rights</h2>
      <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
      ...
      <h2  style={{ fontFamily: 'OpenSans_300Light', fontSize: 28 }}>Do Not Sell My Personal Information</h2>
      <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
      ...
      <h3  style={{ fontFamily: 'OpenSans_300Light', fontSize: 22 }}>Website</h3>
      <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
      ...
      <h3  style={{ fontFamily: 'OpenSans_300Light', fontSize: 22 }}>Mobile Devices</h3>
      <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
      ...
      <h1  style={{ fontFamily: 'OpenSans_300Light', fontSize: 32 }}>
        &quot;Do Not Track&quot; Policy as Required by California Online Privacy
        Protection Act (CalOPPA)
      </h1>
      <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>Our Service does not respond to Do Not Track signals.</p>
      <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
      ...
      <h1  style={{ fontFamily: 'OpenSans_300Light', fontSize: 32 }}>Your California Privacy Rights (California's Shine the Light law)</h1>
      <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
      ...
      <h1  style={{ fontFamily: 'OpenSans_300Light', fontSize: 32 }}>Links to Other Websites</h1>
      <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
      ...
      <h1  style={{ fontFamily: 'OpenSans_300Light', fontSize: 32 }}>Changes to this Privacy Policy</h1>
      <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
      ...
      <h1  style={{ fontFamily: 'OpenSans_300Light', fontSize: 32 }}>Contact Us</h1>
      <p  style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
      ...
      <ul style={{ fontFamily: 'OpenSans_300Light', fontSize: 16 }}>
        <li>
          ...
          {/* <a
            ...
            class='__cf_email__'
            data-cfemail='304340555e53554270405f4244515c431e5e5544'
          > */}
            spencer@portals.net
          {/* </a> */}
        </li>
